...
namespace SignalRApi.Hubs
{
	public class SignalRHub:Hub
	{
        ...
        public async Task SendStatistic()
		{
            ...
            var value10 = _productService.TProductAvgPriceByHambuger();
            await Clients.All.SendAsync("ReceiveProductAvgPriceByHambuger", value10.ToString("0.00") + " ₺ ");
        ...
        public async Task GetBookingList()
        {
            ...
            await Clients.All.SendAsync("ReceivedBookingList", values);
        }
        ...
        {  //cliente bağlı clientcount sayısı
            clientCount++;
